...
const FEATURES = [
  ...
  { icon: RefreshCw,   label: "Idempotent Destroy",        desc: "hermes-deploy destroy tears down cloud + config" },
  { icon: Zap,         label: "1-line Install",            desc: "curl | bash · auto-detects macOS or Linux" },
  { icon: FileCode2,   label: "Config Persistence",        desc: "~/.hermes-deploy/config, key/value store" },
